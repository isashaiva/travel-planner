...
function RouteCardSkeleton() {
  return (
    <div className="relative overflow-hidden rounded-[34px] border border-sky-100 bg-white shadow-lg flex flex-col h-full animate-pulse">
      ...
      <div className="p-7 flex flex-col flex-1 gap-4">
        <div className="flex items-start justify-between">
          ...
          <div className="w-20 h-9 bg-slate-100 rounded-2xl ml-4" />
        </div>
        ...
        <div className="mt-auto h-36 bg-slate-100 rounded-3xl" />
        <div className="h-14 bg-slate-100 rounded-2xl" />
      </div>
    </div>
  );
...
export default function TripGeneratorPage() {
  ...
  const handleSelect = async (lat: number, lng: number) => {
    ...
    setSelectedCity({ lat, lng, city: cityData.city });
        ...
        {generatingRoutes && (
          <div className="py-12">
            <div className="max-w-md mx-auto text-center mb-12">
              <div className="w-20 h-20 border-4 border-sky-200 border-t-sky-500 rounded-full animate-spin mx-auto mb-6" />
              ...
              >
                ...
                <div className="p-7 flex flex-col flex-1">
                  ...
                  <button
                    ...
                    className="w-full mt-6 bg-sky-500 hover:bg-sky-600 active:scale-[0.99] text-white py-4 rounded-2xl font-black text-lg transition-all shadow-lg shadow-sky-200 disabled:opacity-70 flex items-center justify-center gap-2"
                  >
                    {savingId === route.id ? (
                      <>
